...
export interface ApiFooterLogoFooterLogo extends Struct.SingleTypeSchema {
...
export interface ApiFooterNavLinkFooterNavLink
  extends Struct.CollectionTypeSchema {
  collectionName: 'footer_nav_links';
  info: {
    displayName: 'footer-nav-link';
    pluralName: 'footer-nav-links';
    singularName: 'footer-nav-link';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer-nav-link.footer-nav-link'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
